...
#######################################
## Prof. Kemp test
def prof_kemp(robot,controller_state):
    lift_height_m = 0.75 # lift height goal in meters
    auto_robot = controller_state['left_button_pressed']
    if auto_robot and robot.is_calibrated():
        robot.lift.move_to(lift_height_m)	
    ...
    try:
        ...
        while True:
            ...
            if not robot.is_calibrated():
                ...
                prof_kemp(robot, controller_state)
